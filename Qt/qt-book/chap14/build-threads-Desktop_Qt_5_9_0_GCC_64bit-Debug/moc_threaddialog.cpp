...
#include "../threads/threaddialog.h"
...
struct qt_meta_stringdata_ThreadDialog_t {
    QByteArrayData data[4];
    char stringdata0[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ThreadDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ThreadDialog_t qt_meta_stringdata_ThreadDialog = {
    {
QT_MOC_LITERAL(0, 0, 12), // "ThreadDialog"
QT_MOC_LITERAL(1, 13, 18), // "startOrStopThreadA"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 18) // "startOrStopThreadB"

    },
    "ThreadDialog\0startOrStopThreadA\0\0"
    "startOrStopThreadB"
};
...
const QMetaObject ThreadDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ThreadDialog.data,
      qt_meta_data_ThreadDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *ThreadDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ThreadDialog.stringdata0))
